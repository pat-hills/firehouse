...
<body>
   ...
   <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
           ...
           <a class="navbar-brand" href="./pages/r?inv17ml44=protocol_dashboard"><img width=120x; height=auto; src="../assets/images/logo20.png"/></a>
               ...
               <nav class="navbar navbar-expand-lg navbar-light">
                   ...
                   <div class="collapse navbar-collapse" id="navbarNav">
                       <ul class="navbar-nav flex-column">
                                       ...
                                       <li class="nav-item">
                                           ...
                                           <div id="submenu-1-2" class="collapse submenu" style="">
                                               <ul class="nav flex-column">
                                                   ...
                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=protocol_dashboard"> Dashboard</a>
                                                   </li>
                                                   <!-- <li class="nav-item">
                           ...
                           <li class="nav-item">
                               <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-sort-alpha-up"></i>Attendance</a>
                               <div id="submenu-2" class="collapse submenu" style="">
                                   ...
                                   <li class="nav-item">
                                           <a class="nav-link" href="./pages/r?inv17ml44=add_event">Track Attendance</a>
                                       </li>
...
<!--                             
                           ...
                           <li class="nav-item">
                               <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-users"></i> Members & More </a>
