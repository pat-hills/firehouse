...
<body>
   ...
   <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
           ...
           <a class="navbar-brand" href="./pages/r?inv17ml44=resident_pastor_dashboard"><img width=120x; height=auto; src="../assets/images/logo20.png"/></a>
               ...
               <nav class="navbar navbar-expand-lg navbar-light">
                   ...
                   <div class="collapse navbar-collapse" id="navbarNav">
                       <ul class="navbar-nav flex-column">
                                       ...
                                       <li class="nav-item">
                                           ...
                                           <div id="submenu-1-2" class="collapse submenu" style="">
                                               <ul class="nav flex-column">
                                                   ...
                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=resident_pastor_dashboard"> My Dashboard</a>
                                                   </li>

                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=r_metrics"> Metrics</a>
                                                   </li>

                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=r_metrics_charts"> Metrical Charts</a>
                                                   </li>
                           ...
                           <li class="nav-item">
                               <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-money-bill-alt"></i>Payments</a>
                               <div id="submenu-2" class="collapse submenu" style="">
                                   ...
                                   <a class="nav-link" href="./pages/r?inv17ml44=r_add_offering">Record Offering</a>
                               </li>


                                   <li class="nav-item">
                                   
                                           <a class="nav-link" href="./pages/r?inv17ml44=r_view_members_for_payments">Receive Payments</a>
                                       </li>
...
<!--                             
                           ...
                           <li class="nav-item">
                               <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-file"></i> Financials </a>
...
<!--                                     
                                     ...
                                     <li class="nav-item"> 
                                       ...
                                       <li class="nav-item"> 
                                           <a class="nav-link" href="./pages/r?inv17ml44=income_statement_account_ko_entype">Income Statement Business Breakdown</a>
                                       </li>
                      ...
                      <!-- <li class="nav-item">
                          income_statement_account_ko_entype.php
