...
<body>
   ...
   <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
           ...
           <a class="navbar-brand" href="./pages/r?inv17ml44=admin_dashboard"><img width=120x; height=auto; src="../assets/images/logo20.png"/></a>
                       ...
                       <ul class="navbar-nav flex-column">
                                       ...
                                       <li class="nav-item">
                                           ...
                                           <div id="submenu-1-2" class="collapse submenu" style="">
                                               <ul class="nav flex-column">
                                                   ...
                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=admin_dashboard"> My Dashboard</a>
                                                   </li>

                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=metrics"> Metrics</a>
                                                   </li>

                                                   <li class="nav-item">
                                                       <a class="nav-link" href="./pages/r?inv17ml44=metrics_charts"> Metrical Charts</a>
                                                   </li>
                           ...
                           <li class="nav-item">
                               ...
                               <div id="submenu-2" class="collapse submenu" style="">
                                   ...
                                   <a class="nav-link" href="./pages/r?inv17ml44=add_offering">Record Offering</a>
                               </li>
                                   ...
                                   <li class="nav-item">
                                           ...
                                           <a class="nav-link" href="./pages/r?inv17ml44=view_members_for_payments">Receive Payments</a>
                                       </li>
