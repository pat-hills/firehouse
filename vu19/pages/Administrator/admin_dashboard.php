 ...
 <div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <a href="./pages/r?inv17ml44=view_users">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <a href="./pages/r?inv17ml44=view_members_for_payments">
                    <div style="border-radius:10px; height:230px;" class="card">
                        <div  style="text-align: center;" class="card-body">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <a href="./pages/r?inv17ml44=metrics_list">
                        <div style="border-radius:10px; height:230px;" class="card">
                            <div style="text-align: center;" class="card-body">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <a href="./pages/r?inv17ml44=metrics_charts">
                    <div style="border-radius:10px; height:230px;" class="card">
                        <div style="text-align: center;" class="card-body">
