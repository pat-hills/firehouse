                       ...
                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   ...
                                   <form method="post" action="pages/Administrator/Actions/payments_ledger_action.php" class='form-horizontal' role='form'>
                                       ...
                                       <div class="row pt-2 pt-sm-5 mt-1">
                                           ...
                                           <div class="col-sm-6 pl-0">
                                               <p class="text-right">
                                                   <button  onclick='return confirm("Are you sure you want to contitnue with action?")' name="submitt" class="btn btn-space btn-primary">Save Payment</button>
