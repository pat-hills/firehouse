...
$stmt = $pdo ->prepare('INSERT INTO members(u_id,last_name,first_name,other_name,tittles,gender,dob,birth_day,residence,place_of_birth,region_of_birth,country_of_birth,profession,email_id,phone_number,secondary_number,sms_format_1
,membership_id,tithe_id,welfare_id,date_of_registration,created_by) VALUES 
(:u_id,:last_name,:first_name,:other_name,:tittles,:gender,:dob,:birth_day,:residence,:place_of_birth,:region_of_birth,:country_of_birth,:profession,:email_id,:phone_number,:secondary_number,
