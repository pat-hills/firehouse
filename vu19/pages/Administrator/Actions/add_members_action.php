...
$gender = filter_input(INPUT_POST, 'gender', FILTER_UNSAFE_RAW,FILTER_SANITIZE_SPECIAL_CHARS);
...
$emailLogin = strtolower( filter_input(INPUT_POST, 'emailLogin', FILTER_UNSAFE_RAW,FILTER_SANITIZE_SPECIAL_CHARS));
...
$stmt = $pdo ->prepare('INSERT INTO members(u_id,userid,last_name,first_name,other_name,tittles,gender,dob,birth_day,residence,place_of_birth,region_of_birth,country_of_birth,profession,email_id,phone_number,secondary_number,sms_format_1
,membership_id,tithe_id,welfare_id,date_of_registration,created_by) VALUES 
(:u_id,:userid,:last_name,:first_name,:other_name,:tittles,:gender,:dob,:birth_day,:residence,:place_of_birth,:region_of_birth,:country_of_birth,:profession,:email_id,:phone_number,:secondary_number,
...
$stmt ->bindParam(':welfare_id', $WelfareID); 
 ...
 $stmt ->bindParam(':date_of_registration', $now);
  ...
  $stmt_login_details ->bindParam(':userid', $new_user_id);
  $stmt_login_details ->bindParam(':email', $emailLogin);
  $stmt_login_details ->bindParam(':pass', $hash_pass);
  $stmt_login_details ->bindParam(':user_type', $userType);
...
$stmt_tbl_staff ->bindParam(':staff_id', $new_user_id);
$stmt_tbl_staff ->bindParam(':firstName', $firstname);
$stmt_tbl_staff ->bindParam(':otherNames', $other_name); 
$stmt_tbl_staff ->bindParam(':email', $email_id); 
