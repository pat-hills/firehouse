...
<div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h2 style="" class="pageheader-title">
                           ...
                           <b style="color:#71748d; margin-left:7px;">Guest</b> 
        ...
        <button type="button" class="close" data-dismiss="alert">&times;</button>
          <strong><i class="icon-user icon-large"></i>&nbsp;Guest Registration Completed Sucessfully;  
      </div>
       </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="pages/add_customers_action.php" method="POST">
                                                                       ...
                                                                       <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  autocomplete="off"  name="email" type="email"  data-parsley-type="email" placeholder="Email" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-4 col-lg-10">
                                                                                <input  autocomplete="off" maxlength="10" required  name="primarycontact" type="text"  placeholder="Contact" class="form-control">
                                                                            </div>
                                                                        </div>

                                                                        <div class="form-group row">
                                                                                <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">ID Card</label>
                                                                                <div class="col-9 col-lg-10">
                                                                            ...
                                                                            <div class="form-group row">
                                                                            <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Card No.</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  autocomplete="off"  name="idcardno" type="text"  placeholder="Card No." class="form-control">
                                                                            </div>
                                                                        </div>

                                                                        <div class="form-group row">
                                                                            <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Address</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input required name="residence" type="text"  placeholder="Address" class="form-control">
                                                                            </div>
                                                                        </div>
