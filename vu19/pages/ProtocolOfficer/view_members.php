                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Church Members</h2>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a style="float :right; margin-left:15px;"   href="./pages/r?inv17ml44=p_add_members_new2" class="btn btn-success">
                                          Add Member
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="view_members" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                            <th> Name</th>
                                            <th>Contact</th>
