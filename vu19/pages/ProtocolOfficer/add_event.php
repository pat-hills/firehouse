                                                    ...
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Service</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <select class="form-control" required name="TypeOfService" id="TypeOfService">
                                                                        ...
                                                                        <div style="display: none" class="form-group row NAMEOFPROGRAM">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Program</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text"  name="ProgramName" placeholder="Enter name of program " class="form-control">
                                                                           
                                                                            </div>
                                                                        </div>
                                                                        <div style="display: none" class="form-group row SLOGAN">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Slogan</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text" name="slogan" placeholder="Enter Slogan Or Theme" class="form-control">
                                                                           
                                                                            </div>
                                                                        </div>

                                                                        <div style="" class="form-group row">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Total #</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text" required name="TotalAttendance" placeholder="Enter Number Of Attendance" class="form-control">
