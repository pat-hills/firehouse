...
?> 
 ...
 <div class="dashboard-wrapper">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div style="border-radius:10px;" class="card">
                        <div class="card-body">
                            ...
                            <h3 style="color: #7b27d8;" class="mb-1">Attendance Tracking & More</h3>
                            <div class="metric-value d-inline-block">
                                <h4 class="text-muted">Your head counts today? </br> Record your attendance now!</h4>
                            </div>
                            <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                <a href="./pages/r?inv17ml44=add_event" class="btn btn-danger">Make entries for attendance</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <a href="./pages/r?inv17ml44=p_view_members">
                    <div style="border-radius:10px; height:230px;" class="card">
                        <div style="text-align: center;" class="card-body">
                        <img style="width:60px; height:auto;display: block; margin-left: auto; margin-right: auto;" alt="Total-Friends" src="../images/friends.png" />
                        </br>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <a href="./pages/r?inv17ml44=add_visitor">
                    <div style="border-radius:10px; height:230px;" class="card">
                        <div  style="text-align: center;" class="card-body">
                            <img style="width:60px; height:auto;display: block; margin-left: auto; margin-right: auto;" alt="Total-payments-image" src="../images/visitors.png" />
                        </br>
                            <h3 style="color: #7b27d8;" class="mb-1">Visitors</h3>
                            <div class="metric-value d-inline-block">
                                <h4 class="text-muted">Record and view all visitors</h4>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <a href="./pages/r?inv17ml44=add_event">
                    <div style="border-radius:10px; height:230px;" class="card">
                        <div  style="text-align: center;" class="card-body">
                            <img style="width:60px; height:auto;display: block; margin-left: auto; margin-right: auto;" alt="Total-Metrics-Image" src="../images/report.png" />
                        </br>
                            <h3 style="color: #7b27d8;" class="mb-1">Attendance</h3>
                            <div class="metric-value d-inline-block">
                                <h4 class="text-muted">Record and track your daily attendance</h4>
