                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                                <!-- <h5 class="card-header">Record Attendance</h5> -->
                                                                <div class="card-body">
                                                                    <form  method="POST">
                                                                    ...
                                                                    <div style="" class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input required  type="text"  name="Fullname" placeholder="Enter Fullname Of Visitor " class="form-control">
                                                                        ...
                                                                        <div style="" class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input required  type="text" name="VisitorContact" placeholder="Enter Contact" class="form-control">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <select class="form-control" required name="ReasonJoin" id="ReasonJoin">
                                                                        ...
                                                                        <div style="" class="form-group row">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Church</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text" name="PreviousChurch" placeholder="Enter Previous Church" class="form-control">
                                                                        ...
                                                                        <div style="" class="form-group row">
                                                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Residence</label>
                                                                            <div class="col-9 col-lg-10">
                                                                                <input  type="text" required name="Residence" placeholder="Enter Residence Of Visitor" class="form-control">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                            <input  type="date" required name="dateOfVisit"  class="form-control">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                    ...
                                    <a style="float :right;" href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">
                                            Add Vistor
                                        </a>
