                                                    ...
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="form-group row">
                                                                                <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Acc. type</label>
                                                                                <div class="col-9 col-lg-10">
                                                                            ...
                                                                            <!-- <div class="form-group row">
                                                                                <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Categories</label>
                                                                                <div class="col-9 col-lg-10">
