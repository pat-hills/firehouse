...
<!--                           
              ...
              <div class="col-lg-12">
               ...
               <?php 
                if(isset($_POST['recordOffering'])){
                   $accountant->addOffering();
                }
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Record Offering</h5>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div style="" class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input required  type="text" autocomplete="off"  name="amountOffering" placeholder="Enter Amount Received " class="form-control">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <select class="form-control" required name="typeOfOffering" id="ReasonJoin">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                            <input  type="date" required name="dateOfRecording"  class="form-control">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                                ...
                                                                                <button type="submit" name="recordOffering" class="btn btn-primary">Submit</button>
                                                                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                     ...
                                     $accountant->all_payments_offering(); 
