 ...
 }else
{
  ...
  $business_type = filter_input(INPUT_POST, 'business_type', FILTER_SANITIZE_STRING,FILTER_SANITIZE_SPECIAL_CHARS);
  $description_note = filter_input(INPUT_POST, 'description_note', FILTER_SANITIZE_STRING,FILTER_SANITIZE_SPECIAL_CHARS);



  $acc_type = $accountant -> get_income_exp_type($acc_name);

  $stmtp = $pdo->prepare("UPDATE income_exp SET acc_name =:acc_name, acc_amt= :acc_amt,acc_type =:acc_type,mop =:mop,
  business_type =:business_type,
  description_note =:description_note
    WHERE u_id = :u_id AND id = :id");
  ...
  $stmtp ->bindParam(':mop', $mop,PDO::PARAM_STR);
  $stmtp ->bindParam(':business_type', $business_type,PDO::PARAM_STR);
  $stmtp ->bindParam(':description_note', $description_note,PDO::PARAM_STR);
