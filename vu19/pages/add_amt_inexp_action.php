...
$entity = filter_input(INPUT_POST, 'entity', FILTER_SANITIZE_STRING,FILTER_SANITIZE_SPECIAL_CHARS);
$notes = filter_input(INPUT_POST, 'notes', FILTER_SANITIZE_STRING,FILTER_SANITIZE_SPECIAL_CHARS);
//entity
...
$stmt = $pdo ->prepare('INSERT INTO income_exp(u_id,acc_name,acc_type,acc_amt,mop,business_type,description_note,date_reg,created_by,month_created,year_created) VALUES
 (:u_id,:acc_name,:acc_type,:acc_amt,:mop,:business_type,:description_note,:date_reg,:created_by,:month_created,:year_created)');
...
$stmt ->bindParam(':business_type', $entity);
$stmt ->bindParam(':description_note', $notes);
