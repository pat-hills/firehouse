                                                    ...
                                                    <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                            ...
                                                                            <div class="col-9 col-lg-10">
                                                                                <input autocomplete="off"  type="text" required name="accountAmount" placeholder="Enter Amount" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Entity Type</label>
                                                                                <div class="col-9 col-lg-10">

                                                                                    <select required class="form-control" name="entity">
                                                                                     <option></option>
